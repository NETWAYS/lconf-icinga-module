//<script>
	...
	var filterPanelId = "<?php echo $t['panelIds']['filter'];?>";
	var connectionPanelId = "<?php echo $t['panelIds']['connections'];?>";
	var schemaId = "<?php echo $t['panelIds']['schema'];?>";
	...
	initActionPanelProc = function(cmpRoute) {
		...
		// if its the initial setup, create a new updater which loads the ldap_connManager class	
		var updater = cmpPanel.getUpdater();
		var eventId = AppKit.Ext.genRandomId('CmpReady');
