 ...
 *
 */
class LDAP_LDAPClientModel extends ICINGALDAPBaseModel
{
	/**
	...
	public function setFilter(LDAP_LDAPFilterGroupModel  $filter) {
		$this->filter = $filter;
	}
	public function setSchemaValidator(LDAP_LDAPSchemaValidatorModel $schemaValidator) {
		$this->validator = $validator;
	}
	public function setConnectionModel(LDAP_LDAPConnectionModel $connection) {
	...
	public function __construct(LDAP_LDAPConnectionModel $connection = null) {
		if($connection)	
	...
	public function __sleep() {
		...
		return array('id','_filter','baseDN','schemaValidator','_connectionModel','_contextName','connection','ldap_options','cwd');
	...
	public function __wakeup() {
		...
		// rebuild filters
		if($this->_filter) {
			$this->filter = LDAP_LDAPFilterGroupModel::__fromArray($this->_filter);
			$this->_filter = null;
		}
