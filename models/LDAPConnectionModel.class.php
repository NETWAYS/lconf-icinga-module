...
class LDAP_LDAPConnectionModel extends ICINGALDAPBaseModel
{
	protected $id;
	...
	public function setAuthType($authType) {
		if(in_array($authType,self::$supportedAuthTypes)) {
			...
			throw new AgaviException("Authtype ".$authType." is currently not supported for ldap.");
		}
	}
	...
	public function __construct(array $parameter = null) {
		...
		if(!empty($parameter)) {
			...
			if(isset($parameter["scope"]))
				$this->setScope($parameter["scope"]);
		}
	}
