...
class LDAP_Backend_listDirectorySuccessView extends ICINGALDAPBaseView
{
	public function executeJson(AgaviRequestDataHolder $rd) {
		...
		$client = LDAP_LDAPClientModel::__fromStore($connectionId,$context->getStorage());
	...
	protected function reformatList($list,LDAP_LDAPClientModel $client) {
